...
const zh: Dictionary = {
  ...
  narrative: { noAttempts: "目前还没有测验记录。选择一个等级并开始测验吧——有了数据后，AI将分析您的薄弱环节和学习进度。", summary: "您目前已完成{total}道题，正确率{acc}%（共{days}天有学习记录）。", weakest: "您在{category}方面的正确率略低于其他分类，建议优先复习这一部分。", strongest: "您在{category}方面表现不错，请继续保持。", paceKnown: "按照您目前的学习进度，预计约{weeks}周后可达到{target}水平，通过概率约为{pct}%。", paceUnknown: "还需要再完成几次测验才能估算学习进度。", streak: "你已经连续学习{days}天了。", weakVocabItem: "你经常记错单词「{term}」（{meaning}），建议复习一下。", weakGrammarItem: "在语法方面，建议再复习一下「{pattern}」（{meaning}）。" },
  ...
  studyTime: { title: "学习时间", totalLabel: "总学习时间", todayLabel: "今天", weekLabel: "本周", streakLabel: "连续学习天数", streakDays: "{days}天", trendTitle: "学习时间趋势（最近30天）", trendSubtitle: "每日学习分钟数", minutesUnit: "{minutes}分钟", hoursMinutesUnit: "{hours}小时{minutes}分钟", noStreak: "暂无学习记录", noData: "目前还没有学习时间记录。打开测验或单词列表后即可开始记录。" },
  weakItems: { title: "薄弱单词和语法", subtitle: "这些是你经常出错的项目，建议重点复习。", vocabTitle: "需要复习的单词", grammarTitle: "需要复习的语法", missedCount: "已错{count}次", noWeakVocab: "暂未发现薄弱单词。", noWeakGrammar: "暂未发现薄弱语法。" },
};
